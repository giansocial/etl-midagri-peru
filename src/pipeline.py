...
class ETLPipeline:
    ...
    def _transform(self) -> None:
        ...
        for name, df in self.datasets.items():
            ...
            if "departamento" in df.columns and "produccion_toneladas" in df.columns:
                region_df = self.aggregator.aggregate_by_region(df, "departamento")
                self.exporter.to_csv(region_df, f"{name}_by_region.csv")
